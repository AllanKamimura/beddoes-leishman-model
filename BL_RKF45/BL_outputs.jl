function BL_outputs(t,x,tv0,U,b,beta,k,a_0,a_1,M,x_ac,K0,K1,K2,K3,kappa,K_a,K_aM,K_q,K_qM,T_I,b1,b2,b3,b4,b5,A1,A2,A3,A4,alpha_0L,E0,E1,c_m0,c_n_alpha,r0,alpha_ds0,alpha_ss,S1,S2,Tf0,f0,fb,Vn1,Vn2,Vm,g_v,c_d0,delta_alpha_0,delta_alpha_1,d_cm,d_cc,z_cm,z_cc,nu_1,nu_2,gamma_LS,df0_c,fSig_1n,fSig2_n,fS2_n,fS2_c_up,fS2_c_down,RD_tv0,f_diff_tv0,TvL_tv0,theta_tv0,theta_max,theta_min,RD_m,f_diff_tv0_2,RD_tv0_2,TvL_tv0_2,TvL)
    ...
    # Vortex overshoot  
    delta_cn,delta_cm = vortex_overshoots(tau_v,TvL_tv0,f_diff_tv0,RD_tv0,theta_tv0,Vn1,Vn2,Vm,nu_1,nu_2,g_v,f_diff_tv0_2,RD_tv0_2,TvL_tv0_2,q,P,R,Sigma2,theta,TvL);
    delta_cc = 0;
    ...
    ## Outputs
    y = [alpha; c_n; c_m; c_c; c_nf; c_nI; c_mf; c_mI; delta_cn; delta_cm; delta_cc; f; tau_v; dCP; so_lim; qR; alpha1_n; K_f; c_nC; Tf_n; dalpha1_n; fprime_n; fprime_m; fprime_c; q; dalpha1_m; dalpha1_c; R_dot; Tf_m; Tf_c; theta_min; theta_max; P; S; alpha_E];
    return y
end