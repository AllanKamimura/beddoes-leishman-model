function mov_vars_and_states(t,x,U,b,k,a_0,a_1,r0)
    ...
    return alpha,alpha_dot,q,qR,R,alpha_2dot,q_dot,qR_dot,R_dot,so_state,f2prime_n,f2prime_m,f2prime_c,RD,RD_theta
end