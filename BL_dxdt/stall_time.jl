function stall_time(tv0,f_diff_tv0,RD_tv0,TvL_tv0,theta_tv0,so_state,so_lim,so_i,so_lim_i,t,t_i,f2prime,f,TvL,R,RD,f_diff_tv0_2,RD_tv0_2,TvL_tv0_2,V2F,g_v,theta,gamma_TvL,q)
    ...
    return tv0,tau_v,f_diff_tv0,RD_tv0,TvL_tv0,theta_tv0,f_diff_tv0_2,RD_tv0_2,TvL_tv0_2,V2F
end